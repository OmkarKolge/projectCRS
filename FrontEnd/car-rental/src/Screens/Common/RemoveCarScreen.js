...
const RemoveCarScreen = (props) => {
    ...
    const url = "http://localhost:8081/CarRentalSystem/user/car_list";
    const removeCarUrl = "http://localhost:8081/CarRentalSystem/admin/deleteCar?carId=";
...

                    {
                        carList.map((car) => (
                            <tr>
                                ...
                                <td>{car.price}</td>
                                <td>{car.status}</td>
                                <td><button onClick={() => onDeleteCar(car)} className="btn btn-outline-info">
                                    Delete Car
                                    </button></td>
                            </tr>
                        ))}
